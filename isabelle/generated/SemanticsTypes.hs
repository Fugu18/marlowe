...
module
  SemanticsTypes(Party, equal_Party, ChoiceId, equal_ChoiceId, ValueId,
                  equal_ValueId, Token, equal_Token, Value(..), Observation(..),
                  Payee(..), equal_Payee, Action(..), Contract(..), Case(..),
                  equal_Contract, Input(..), IntervalError(..),
                  Environment_ext(..), State_ext(..), IntervalResult(..),
                  inBounds, choices, minSlot, accounts, boundValues,
                  choices_update, minSlot_update, accounts_update, slotInterval,
                  boundValues_update)
  where {
...
equal_Party (PubKey x1) (Role x2) = False;
equal_Party (Role x2) (PubKey x1) = False;
equal_Party (Role x2) (Role y2) = x2 == y2;
equal_Party (PubKey x1) (PubKey y1) = x1 == y1;
...
data Value = AvailableMoney Party Token | Constant Arith.Int | NegValue Value
  ...
  | DivValue Value Value | Scale Arith.Int Arith.Int Value
  | ChoiceValue ChoiceId | SlotIntervalStart | SlotIntervalEnd
  | UseValue ValueId | Cond Observation Value Value;
...
equal_Value (UseValue x12a) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (UseValue x12a) = False;
equal_Value SlotIntervalEnd (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (UseValue x12a) = False;
equal_Value (UseValue x12a) SlotIntervalEnd = False;
equal_Value SlotIntervalStart (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) SlotIntervalStart = False;
equal_Value SlotIntervalStart (UseValue x12a) = False;
equal_Value (UseValue x12a) SlotIntervalStart = False;
equal_Value SlotIntervalStart SlotIntervalEnd = False;
equal_Value SlotIntervalEnd SlotIntervalStart = False;
equal_Value (ChoiceValue x9) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (UseValue x12a) = False;
equal_Value (UseValue x12a) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) SlotIntervalStart = False;
equal_Value SlotIntervalStart (ChoiceValue x9) = False;
equal_Value (Scale x81 x82 x83) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (UseValue x12a) = False;
equal_Value (UseValue x12a) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) SlotIntervalStart = False;
equal_Value SlotIntervalStart (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (Scale x81 x82 x83) = False;
equal_Value (DivValue x71 x72) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (DivValue x71 x72) = False;
equal_Value (DivValue x71 x72) (UseValue x12a) = False;
equal_Value (UseValue x12a) (DivValue x71 x72) = False;
equal_Value (DivValue x71 x72) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (DivValue x71 x72) = False;
equal_Value (DivValue x71 x72) SlotIntervalStart = False;
equal_Value SlotIntervalStart (DivValue x71 x72) = False;
equal_Value (DivValue x71 x72) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (DivValue x71 x72) = False;
equal_Value (DivValue x71 x72) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (DivValue x71 x72) = False;
equal_Value (MulValue x61 x62) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (MulValue x61 x62) = False;
equal_Value (MulValue x61 x62) (UseValue x12a) = False;
equal_Value (UseValue x12a) (MulValue x61 x62) = False;
equal_Value (MulValue x61 x62) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (MulValue x61 x62) = False;
equal_Value (MulValue x61 x62) SlotIntervalStart = False;
equal_Value SlotIntervalStart (MulValue x61 x62) = False;
equal_Value (MulValue x61 x62) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (MulValue x61 x62) = False;
equal_Value (MulValue x61 x62) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (MulValue x61 x62) = False;
equal_Value (MulValue x61 x62) (DivValue x71 x72) = False;
equal_Value (DivValue x71 x72) (MulValue x61 x62) = False;
equal_Value (SubValue x51 x52) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (SubValue x51 x52) = False;
equal_Value (SubValue x51 x52) (UseValue x12a) = False;
equal_Value (UseValue x12a) (SubValue x51 x52) = False;
equal_Value (SubValue x51 x52) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (SubValue x51 x52) = False;
equal_Value (SubValue x51 x52) SlotIntervalStart = False;
equal_Value SlotIntervalStart (SubValue x51 x52) = False;
equal_Value (SubValue x51 x52) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (SubValue x51 x52) = False;
equal_Value (SubValue x51 x52) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (SubValue x51 x52) = False;
...
equal_Value (AddValue x41 x42) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (AddValue x41 x42) = False;
equal_Value (AddValue x41 x42) (UseValue x12a) = False;
equal_Value (UseValue x12a) (AddValue x41 x42) = False;
equal_Value (AddValue x41 x42) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (AddValue x41 x42) = False;
equal_Value (AddValue x41 x42) SlotIntervalStart = False;
equal_Value SlotIntervalStart (AddValue x41 x42) = False;
equal_Value (AddValue x41 x42) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (AddValue x41 x42) = False;
equal_Value (AddValue x41 x42) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (AddValue x41 x42) = False;
...
equal_Value (NegValue x3) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (NegValue x3) = False;
equal_Value (NegValue x3) (UseValue x12a) = False;
equal_Value (UseValue x12a) (NegValue x3) = False;
equal_Value (NegValue x3) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (NegValue x3) = False;
equal_Value (NegValue x3) SlotIntervalStart = False;
equal_Value SlotIntervalStart (NegValue x3) = False;
equal_Value (NegValue x3) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (NegValue x3) = False;
equal_Value (NegValue x3) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (NegValue x3) = False;
...
equal_Value (Constant x2) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (Constant x2) = False;
equal_Value (Constant x2) (UseValue x12a) = False;
equal_Value (UseValue x12a) (Constant x2) = False;
equal_Value (Constant x2) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (Constant x2) = False;
equal_Value (Constant x2) SlotIntervalStart = False;
equal_Value SlotIntervalStart (Constant x2) = False;
equal_Value (Constant x2) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (Constant x2) = False;
equal_Value (Constant x2) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (Constant x2) = False;
...
equal_Value (AvailableMoney x11 x12) (Cond x131 x132 x133) = False;
equal_Value (Cond x131 x132 x133) (AvailableMoney x11 x12) = False;
equal_Value (AvailableMoney x11 x12) (UseValue x12a) = False;
equal_Value (UseValue x12a) (AvailableMoney x11 x12) = False;
equal_Value (AvailableMoney x11 x12) SlotIntervalEnd = False;
equal_Value SlotIntervalEnd (AvailableMoney x11 x12) = False;
equal_Value (AvailableMoney x11 x12) SlotIntervalStart = False;
equal_Value SlotIntervalStart (AvailableMoney x11 x12) = False;
equal_Value (AvailableMoney x11 x12) (ChoiceValue x9) = False;
equal_Value (ChoiceValue x9) (AvailableMoney x11 x12) = False;
equal_Value (AvailableMoney x11 x12) (Scale x81 x82 x83) = False;
equal_Value (Scale x81 x82 x83) (AvailableMoney x11 x12) = False;
...
equal_Value (Cond x131 x132 x133) (Cond y131 y132 y133) =
  equal_Observation x131 y131 && equal_Value x132 y132 && equal_Value x133 y133;
equal_Value (UseValue x12a) (UseValue y12a) = equal_ValueId x12a y12a;
equal_Value (ChoiceValue x9) (ChoiceValue y9) = equal_ChoiceId x9 y9;
equal_Value (Scale x81 x82 x83) (Scale y81 y82 y83) =
  Arith.equal_int x81 y81 && Arith.equal_int x82 y82 && equal_Value x83 y83;
...
equal_Value SlotIntervalEnd SlotIntervalEnd = True;
equal_Value SlotIntervalStart SlotIntervalStart = True;
...
less_eq_Party (PubKey uu) (Role uv) = True;
less_eq_Party (Role uw) (PubKey ux) = False;
less_eq_Party (PubKey x) (PubKey y) = Serialisation.less_eq_BS x y;
less_eq_Party (Role x) (Role y) = Serialisation.less_eq_BS x y;

less_eq_Partya :: Party -> Party -> Bool;
less_eq_Partya a b = less_eq_Party a b;

less_Party :: Party -> Party -> Bool;
less_Party a b = not (less_eq_Party b a);

less_Partya :: Party -> Party -> Bool;
less_Partya a b = less_Party a b;

instance Orderings.Ord Party where {
  less_eq = less_eq_Partya;
  less = less_Partya;
};

instance Orderings.Preorder Party where {
};

instance Orderings.Order Party where {
};

instance Orderings.Linorder Party where {
};
...
less_eq_Token :: Token -> Token -> Bool;
less_eq_Token a b = less_eq_Tok a b;

less_Tok :: Token -> Token -> Bool;
less_Tok a b = not (less_eq_Tok b a);

less_Token :: Token -> Token -> Bool;
less_Token a b = less_Tok a b;

instance Orderings.Ord Token where {
  less_eq = less_eq_Token;
  less = less_Token;
};

instance Orderings.Preorder Token where {
};

instance Orderings.Order Token where {
};

instance Orderings.Linorder Token where {
};
...
less_eq_ValId :: ValueId -> ValueId -> Bool;
less_eq_ValId (ValueId a) (ValueId b) = Serialisation.less_eq_BS a b;

less_eq_ValueId :: ValueId -> ValueId -> Bool;
less_eq_ValueId a b = less_eq_ValId a b;

less_ValId :: ValueId -> ValueId -> Bool;
less_ValId (ValueId a) (ValueId b) = Serialisation.less_BS a b;

less_ValueId :: ValueId -> ValueId -> Bool;
less_ValueId a b = less_ValId a b;

instance Orderings.Ord ValueId where {
  less_eq = less_eq_ValueId;
  less = less_ValueId;
};

instance Orderings.Preorder ValueId where {
};

instance Orderings.Order ValueId where {
};

instance Orderings.Linorder ValueId where {
};
...
less_eq_ChoId :: ChoiceId -> ChoiceId -> Bool;
less_eq_ChoId (ChoiceId a b) (ChoiceId c d) =
  (if Serialisation.less_BS a c then True
    else (if Serialisation.less_BS c a then False else less_eq_Partya b d));

less_eq_ChoiceId :: ChoiceId -> ChoiceId -> Bool;
less_eq_ChoiceId a b = less_eq_ChoId a b;

less_ChoId :: ChoiceId -> ChoiceId -> Bool;
less_ChoId a b = not (less_eq_ChoId b a);

less_ChoiceId :: ChoiceId -> ChoiceId -> Bool;
less_ChoiceId a b = less_ChoId a b;

instance Orderings.Ord ChoiceId where {
  less_eq = less_eq_ChoiceId;
  less = less_ChoiceId;
};

instance Orderings.Preorder ChoiceId where {
};

instance Orderings.Order ChoiceId where {
};

instance Orderings.Linorder ChoiceId where {
};
...
choices (State_ext accounts choices boundValues minSlot more) = choices;

minSlot :: forall a. State_ext a -> Arith.Int;
minSlot (State_ext accounts choices boundValues minSlot more) = minSlot;

accounts :: forall a. State_ext a -> [((Party, Token), Arith.Int)];
accounts (State_ext accounts choices boundValues minSlot more) = accounts;

boundValues :: forall a. State_ext a -> [(ValueId, Arith.Int)];
boundValues (State_ext accounts choices boundValues minSlot more) = boundValues;

choices_update ::
  forall a.
    ([(ChoiceId, Arith.Int)] -> [(ChoiceId, Arith.Int)]) ->
      State_ext a -> State_ext a;
choices_update choicesa (State_ext accounts choices boundValues minSlot more) =
  State_ext accounts (choicesa choices) boundValues minSlot more;

minSlot_update ::
  forall a. (Arith.Int -> Arith.Int) -> State_ext a -> State_ext a;
minSlot_update minSlota (State_ext accounts choices boundValues minSlot more) =
  State_ext accounts choices boundValues (minSlota minSlot) more;

accounts_update ::
  forall a.
    ([((Party, Token), Arith.Int)] -> [((Party, Token), Arith.Int)]) ->
      State_ext a -> State_ext a;
accounts_update accountsa (State_ext accounts choices boundValues minSlot more)
  = State_ext (accountsa accounts) choices boundValues minSlot more;

slotInterval :: forall a. Environment_ext a -> (Arith.Int, Arith.Int);
slotInterval (Environment_ext slotInterval more) = slotInterval;
...
boundValues_update boundValuesa
  (State_ext accounts choices boundValues minSlot more) =
  State_ext accounts choices (boundValuesa boundValues) minSlot more;
